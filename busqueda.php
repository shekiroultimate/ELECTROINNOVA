            ...
            <div class="border p-4 rounded mb-4">
              ...
              <div class="mb-4">
                ...
                <label for="s_sm" class="d-flex">
                  <a href="./busqueda.php?texto=14">
                  <input type="checkbox" id="s_sm" class="mr-2 mt-1"> <span class="text-black">14</span>
                  </a>
                </label>
                <label for="s_md" class="d-flex">
                  <a href="./busqueda.php?texto=15,6">
                  <input type="checkbox" id="s_sm" class="mr-2 mt-1"> <span class="text-black">15,6</span>
                  </a>                
                </label>
                <label for="s_lg" class="d-flex">
                  <a href="./busqueda.php?texto=16">
                  <input type="checkbox" id="s_sm" class="mr-2 mt-1"> <span class="text-black">16</span>
                  </a>  
                </label>
              </div>
              ...
              <div class="mb-4">
                ...
                <?php
                  $re = $conexion->query("SELECT * FROM colore");
                  while($f=mysqli_fetch_array($re)){
                ?>
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img src="images/Labtop JP.webp" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img src="images/Telefono Z.webp" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                        <span class="text-uppercase">Collections</span>
                        <h3>Telefonos</h3>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img src="images/Reloj XDH.webp" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                        <span class="text-uppercase">Collections</span>
                        <h3>Relojes</h3>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img src="images/Audifono con cable.webp" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                        <span class="text-uppercase">Collections</span>
                        <h3>Audifonos</h3>
